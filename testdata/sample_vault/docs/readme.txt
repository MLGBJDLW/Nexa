...
3. 首次启动时，选择要监控的文件夹
   On first launch, select the folders to monitor

支持的文件格式 Supported File Formats
======================================

- Markdown (.md) — 支持标题解析、代码块识别
  Supports heading parsing, code block recognition

- 纯文本 Plain Text (.txt) — 基于段落的分块
  Paragraph-based chunking

- 日志文件 Log Files (.log) — 时间戳感知的分块
