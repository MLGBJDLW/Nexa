...
export interface TranslationKeys {
  ...
  'chat.contextRuntimeModel': string;
  'chat.contextNoModel': string;
  'chat.contextWindowValue': string;
  'chat.contextWindowPending': string;
  'chat.contextReasoningLabel': string;
  'chat.contextReasoningEnabled': string;
  'chat.contextReasoningDisabled': string;
  'chat.contextReasoningOff': string;
  'chat.contextReasoningOn': string;
  'chat.contextReasoningEffort': string;
  'chat.contextThinkingBudget': string;
  'chat.contextToolPolicyLabel': string;
  'chat.contextDefaultSourceAuthority': string;
  'chat.contextDefaultToolPolicy': string;
  'chat.contextDefaultMemoryPolicy': string;
  ...
  'chat.taskRunLabel': string;
  'chat.taskRunDefaultTitle': string;
  'chat.taskRunQueued': string;
  'chat.taskRunRunning': string;
  'chat.taskRunWaitingApproval': string;
  'chat.taskRunCancelling': string;
  'chat.taskRunCancelled': string;
  'chat.taskRunTimedOut': string;
  'chat.taskRunFailed': string;
  'chat.taskRunCompleted': string;
  'chat.taskRunUnknown': string;
  'chat.taskEventQueued': string;
  'chat.taskEventStarted': string;
  'chat.taskEventRouteSelected': string;
  'chat.taskEventRouteSelectedWithRoute': string;
  'chat.taskEventFinalAnswer': string;
  'chat.taskEventFailed': string;
  'chat.taskEventCompacted': string;
  'chat.taskEventApprovalResolved': string;
  'chat.taskEventStopRequested': string;
  'chat.taskEventStopped': string;
  'chat.taskPhaseQueued': string;
  'chat.taskPhaseInitializing': string;
  'chat.taskPhaseRouting': string;
  'chat.taskPhaseReasoning': string;
  'chat.taskPhaseTooling': string;
  'chat.taskPhaseApproval': string;
  'chat.taskPhaseGenerating': string;
  'chat.taskPhaseFinalizing': string;
  'chat.taskPhaseCancelling': string;
  'chat.taskPhaseDone': string;
  ...
  // Skills — friendly pack (P0)
  'settings.skillTabEdit': string;
  'settings.skillTabPreview': string;
  'settings.skillTabSplit': string;
  'settings.skillSearchPlaceholder': string;
  'settings.skillFilterAll': string;
  'settings.skillFilterBuiltin': string;
  'settings.skillFilterUser': string;
  'settings.skillFilterEnabled': string;
  ...
  'settings.skillShortcutHint': string;
  'settings.skillImportScanTitle': string;
  'settings.skillImportScanSubtitle': string;
  'settings.skillImportProceed': string;
  'settings.skillPreviewTriggers': string;
  'settings.skillPreviewAllowedTools': string;
  'settings.skillPreviewLicense': string;
  'settings.skillPreviewEmpty': string;
  ...
  'wizard.skip': string;
  'wizard.skipped': string;
  'wizard.getStarted': string;
  'wizard.welcomeTitle': string;
  'wizard.welcomeSubtitle': string;
  'wizard.welcomeDescription': string;
  'wizard.languageTitle': string;
  'wizard.languageDescription': string;
  'wizard.providerTitle': string;
  'wizard.providerDescription': string;
  'wizard.apiKey': string;
  'wizard.testConnection': string;
  'wizard.connectionSuccess': string;
  'wizard.connectionFailed': string;
  'wizard.sourceTitle': string;
  'wizard.sourceDescription': string;
  'wizard.selectFolder': string;
  'wizard.folderSelected': string;
  'wizard.folderError': string;
  'wizard.indexingTitle': string;
  'wizard.indexingDoneTitle': string;
  'wizard.indexingDescription': string;
  'wizard.indexingInProgress': string;
  'wizard.indexingStarting': string;
  'wizard.indexingProgress': string;
  'wizard.indexingDone': string;
  'wizard.indexingError': string;
  'wizard.indexingRetry': string;
  'wizard.indexingBackground': string;
  'wizard.indexingNoSource': string;
  'wizard.continueLater': string;
  'wizard.doneTitle': string;
  'wizard.doneDescription': string;
  'wizard.enterApp': string;
  'wizard.openSampleChat': string;
  'wizard.completeError': string;
  'wizard.rerunLabel': string;
  'wizard.rerunDescription': string;
